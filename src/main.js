...
if(films.length === 0) {
  render(siteMainElement, new NoFilmsMessageView(FilterType.ALL).element, renderPosition.BEFOREEND);
} else {
...
render(siteFooterStatisticsElement, new FooterStatisticsView(films).element, renderPosition.BEFOREEND);
